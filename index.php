...
<body>
   ...
   <header id="top">
   	...
   	<div class="row">
   		...
   		<div class="header-content twelve columns">
		      ...
		      <h1 id="logo-text"><a href="index.php" title="">Ashley's Blog （＾ω＾）</a></h1>
				<p id="intro">Welcome to my blog! Documenting my life in America as a student!</p>
   ...
   <div id="content-wrap">
     ...
     ?>
          ...
          <h3>Hello I love you please let me talk to you again</h3>
          <p>Please stop bothering me Samuel! Please get off my blog!</p><br/>

          <button type='button' value='Add Category' /><a href="post.php">Post something nice on my wall!</a></button>
