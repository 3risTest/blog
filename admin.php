...
<body>
   ...
   <header id="top">
   	...
   	<div class="row">
   		...
   		<div class="header-content twelve columns">
		      ...
		      <h1 id="logo-text"><a href="index.php" title="">Admin Console</a></h1>
				<p id="intro">Welcome, Ashley Hoffmann!</p>
   ...
   <div id="content-wrap">
    ...
    <button type='button' value='Add Category' /><a href="user_info.php">View User Info</a></button>
